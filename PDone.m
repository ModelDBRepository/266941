...
aee_s=-5e1/fac;       W_EEs= aee_s*r_s;             %Layer S (was -1e-2 for IEEE paper)
aee_m=-5e1/fac;       W_EEm= aee_m*r_m;             %Layer M (was -1e-2 for IEEE paper)
aee_d=-5e1/fac;       W_EEd= aee_d*r_d;             %Layer D (was -1e-2 for IEEE paper)
aii_INs=-5e1/fac;    W_IIins= aii_INs*r_ins;        %INs
...
%S
aee_sm=3e2/fac;   W_EEsm=aee_sm*r_s;             %M to S couplings
aee_sd=5e2/fac;      W_EEsd=aee_sd*r_s;             %D to S couplings
aei_sINs=-7.5e2/fac;    W_EIsINs=aei_sINs*r_s;         %INs to S couplings
aei_sRet=0/fac;      W_EIsRet=aei_sRet*r_s;         %Ret. to S couplings
aee_sRel=0/fac;      W_EEsRel=aee_sRel*r_s;         %Rel. to S couplings
%M
aee_ms=1e1/fac;      W_EEms=aee_ms*r_m;             %S to M couplings
aee_md=0/fac;        W_EEmd=aee_md*r_m;             %D to M couplings
aei_mINs=-7.5e2/fac;    W_EImINs=aei_mINs*r_m;         %INs to M couplings
...
aei_dINs=-5e3/fac;   W_EIdINs=aei_dINs*r_d;         %INs to D couplings
aei_dRet=0/fac;      W_EIdRet=aei_dRet*r_d;         %Ret. to D couplings
aee_dRel=1e3/fac;    W_EEdRel=aee_dRel*r_d;         %Rel. to D couplings
%INs
